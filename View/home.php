  ...
  <section id="examples" class="text-center">
      ...
      <div class="row">
            ...
            <?php
                ...
                while($set=$result->fetch())://$set là array[mahh:24,tenhh:giày...]
            ?>
  ...
  <section id="examples" class="text-center">
      ...
      <div class="row">
         <?php
            $km=$hh-> getHangHoaSale(); //Trả về 4 sản phẩm khuyến mãi
            while($set=$km-> fetch()){
         ?>
              ...
              <div class="col-lg-3 col-md-4 mb-3 text-left">
                  ...
                  <h5 class="my-4 font-weight-bold">
                      <font color="red"><sup><?php echo $set['giamgia']; ?><u>đ</u></sup></font>
