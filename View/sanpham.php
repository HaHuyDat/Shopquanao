...
<div class="row">
    <div class="col-lg-8 text-right">
      ...
      <div class="row">
        <?php 
            ...
            if($ac==2)
            {
                $result=$hh->getHangHoaAllSale();// bảng 8 sản phẩm
            }
            if($ac==3)
            {
              ...
              <div class="col-lg-3 col-md-4 mb-3 text-left">
                  ...
                  <?php 
                    ...
                    if($ac==2)
                    {
                        ...
                        <font color="red">'.number_format($set['giamgia']).'<sup><u>đ</u></sup></br>
  ...
  <div class="col-md-6 div col-md-offset-3">
	<!--Phân trang-->
            <ul class="pagination">
				<?php
                //Nút lùi, khi nào lùi, khi trang hiện nó lớn hơn và tổng số trang >1
                // $current_page=isset($_GET['page'])?$_GET['page']:1;
